	...
	<div id="k2Container" class="k2AccountPage">
		<table class="admintable" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td>
					<span class="input-large uneditable-input"><b><?php echo $this->user->get('username'); ?></b></span>
				</td>
			</tr>
			<tr>
				<td class="key">
		...
		<div class="k2AccountPageUpdate">
			<button class="button btn validate" type="submit" onclick="submitbutton( this.form );return false;">
